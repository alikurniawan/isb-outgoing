...
//	email  : pinotoy@yahoo.com
	...
	var language = 'en';	        // Default Language: en - english ; es - spanish; de - german; pl - polish
	...
	var imgDir = 'popcal2/';	// directory for images ... e.g. var imgDir="/img/" //m227
	var dayName = '';
	...
	var gotoString = {
		...
		pl : 'Przejdü do obecnego miesiπca'
	};
	var todayString = {
		en : 'Today is',
		es : 'Hoy es',
	...
	var scrollLeftMessage = {
		...
		pl : 'Naciúnij aby przejúÊ do poprzedniego miesiπca. Przytrzymaj aby przewijaÊ automatycznie.'
	};
	var scrollRightMessage = {
		...
		pl : 'Naciúnij aby przejúÊ do nastÍpnego miesiπca. Przytrzymaj aby przewijaÊ automatycznie.'
	};
	var selectMonthMessage = {
		en : 'Click to select a month.',
		es : 'Presione para seleccionar un mes',
		de : 'Klicken um Monat auszuw‰hlen',
		pl : 'Naciúnij aby wybraÊ miesiπc'
	};
	var selectYearMessage = {
		en : 'Click to select a year.',
		es : 'Presione para seleccionar un aÒo',
		de : 'Klicken um Jahr auszuw‰hlen',
		pl : 'Naciúnij aby wybraÊ rok'
	};
	...
	var	monthName = {
		...
		pl : new Array('styczeÒ','luty','marzec','kwiecieÒ','maj','czerwiec','lipiec','sierpieÒ','wrzesieÒ','paüdziernik','listopad','grudzieÒ')
	};
	var	monthName2 = {
		...
		pl : new Array('STY','LUT','MAR','KWI','MAJ','CZE','LIP','SIE','WRZ','PAè','LIS','GRU')
	};
	...
	if (startAt==0) {
		dayName = {
			...
			pl : new Array('n','pn','wt','úr','cz','pt','so')
		};
	} else {
		dayName = {
			...
			pl : new Array('pn','wt','úr','cz','pt','so','n')
		};
	}
	...
	*/
	...
	function init() {		
		if (!ns4)
		{
			...
			if (!ie) yearNow += 1900;
      if (yearNow < 500) yearNow += 1900; // corrected false ie detection in OPERA thus year 10x .... (m227)
	...
	//////////  Modifications m227   //////////
	///////////////////////////////////////////
        function m227showCal(ctl, ctl2, field_nr, format, lang, past, fx, fy) //m227 added by m227 :)
        {
        	ctl2 = document.getElementById("datedest"+field_nr);        	
        	//ctl2 = document.getElementByName("phpmysqlgrid_setdata["+field_nr+"]");        	
        	showCalendar(ctl, ctl2, format, lang, past, fx, fy)
        }
        /// END :)
